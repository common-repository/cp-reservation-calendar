...
$nonce = wp_create_nonce( 'dexres_update_data' );

if (!defined('CP_CALENDAR_ID'))
    define ('CP_CALENDAR_ID',1);

global $wpdb; 
$mycalendarrows = $wpdb->get_results( 'SELECT * FROM '.DEX_RESERVATIONS_CONFIG_TABLE_NAME .' WHERE `'.TDE_RESERVATIONCONFIG_ID.'`='.intval(CP_CALENDAR_ID)); 
...
<div id="normal-sortables" class="meta-box-sortables">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
   ...
   <script>
   var pathCalendar = "<?php echo cp_reservation_get_site_url(true); ?>";
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td><input required type="email" name="paypal_email" size="40" value="<?php echo esc_attr(dex_reservations_get_option('paypal_email',DEX_RESERVATIONS_DEFAULT_PAYPAL_EMAIL)); ?>" /></td>
        </tr>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <td><input required type="email" name="notification_from_email" size="40" value="<?php echo esc_attr(dex_reservations_get_option('notification_from_email', DEX_RESERVATIONS_DEFAULT_PAYPAL_EMAIL)); ?>" /></td>
        </tr>             
        <tr valign="top">
        <th scope="row">Send notification to email</th>
        <td><input required type="email" name="notification_destination_email" size="40" value="<?php echo esc_attr(dex_reservations_get_option('notification_destination_email', DEX_RESERVATIONS_DEFAULT_PAYPAL_EMAIL)); ?>" /></td>
        </tr>
        <tr valign="top">
        ...
        <td><textarea cols="70" rows="5" name="email_confirmation_to_user"><?php echo esc_textarea(dex_reservations_get_option('email_confirmation_to_user', DEX_RESERVATIONS_DEFAULT_CONFIRMATION_EMAIL)); ?></textarea></td>
        </tr>
        <tr valign="top">
        ...
        <td><textarea cols="70" rows="5" name="email_notification_to_admin"><?php echo esc_textarea(dex_reservations_get_option('email_notification_to_admin', DEX_RESERVATIONS_DEFAULT_NOTIFICATION_EMAIL)); ?></textarea></td>
        </tr>                                                
     </table>  
  </div>    
 </div>  
